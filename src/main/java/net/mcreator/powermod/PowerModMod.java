 ...
 *
 *    Keep the PowerModModElements object in this class and all calls to this object
...
@Mod("power_mod")
public class PowerModMod {
	public static final Logger LOGGER = LogManager.getLogger(PowerModMod.class);
	...
	public PowerModMod() {
		...
		MinecraftForge.EVENT_BUS.register(new PowerModModFMLBusEvents(this));
	}
